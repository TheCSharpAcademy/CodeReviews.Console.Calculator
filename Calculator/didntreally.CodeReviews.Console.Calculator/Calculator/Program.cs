    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while(runCalculator)
            {
                ...
                //Ask User to type in second numebr
                ...
                //tell user to enter a valid alphabet when they enter a int or whitespace
                ...
                //insert the inputs to calculator.operation method
                double result = Calculator.Operation(numInput1, numInput2, userInput);

                //catch the exception, when the result is NaN
