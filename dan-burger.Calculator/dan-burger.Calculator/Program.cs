...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (!endApp)
        {
            ...
            Console.WriteLine($"Calculator used {calculator.timesUsed} time(s)!");
            Console.Write(@"Press 'n' and Enter to close the app 
Press 'l' to see a list of past calculations
Press 'd' to delete the list of past calculations
